...
const RemovedArticlesPage = () => {
  ...
  const { mutate: restoreArticleHandler, isLoading } = useMutation({
    mutationFn: ({ id }) => {
...
<Button className=' bg-blue-900/90 '>Nowy artykuł</Button>
      ...
      {viewType === "grid" && (
        <div className="grid grid-row  xl:grid-cols-[10fr_16fr] gap-4  h-fit px-3  max-w-[1740px] mx-auto  ">
...
export default RemovedArticlesPage;
