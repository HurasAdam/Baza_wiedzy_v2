...
const UnverifiedEvent = ({ historyItem }: Props) => {
    ...
    return (
        <div className="history-details py-6 px-4 rounded-lg shadow-md bg-card relative overflow-hidden h-full">
            ...
            <div className="relative z-10 flex flex-col py-5 px-3 min-h-full">
                <h3 className="text-2xl font-bold mb-5 z-10 text-foreground">❌ Cofnięto weryfikację artykułu</h3>
                ...
                <div className="p-4 rounded-2xl border border-white/30 bg-white/10 backdrop-blur-md shadow-lg">
                    <h3 className="text-lg font-semibold mb-3 text-foreground">
                        Status weryfikacji artukułu został zmieniony przez:
                    </h3>
            ...
            <div className="absolute top-0 left-0 w-full h-full z-0">
                <img src={IMAGES.unverifiedImage} alt="Tło unieważnienia" className="object-cover w-full opacity-50" />
            </div>
        </div>
    );
};
