...
const QuickArticleDetails: React.FC = ({ articleId, type }) => {
    ...
    const {
        ...
        queryFn: () => {
            return articleApi.getArticle({ id: id || articleId });
        },
    });
                ...
                <div className="  px-5 mb-2 flex flex-col justify-between rounded-xl word-break: break-all ">
                    ...
                    <div className="py-3 px-0.5 space-x-1 space-y-1.5">
                        {article?.tags?.map((tag) => {
                            return <BadgeLabel className="bg-badge_primary rounded-lg" label={tag?.name} />;
                        })}
                    </div>
                        ...
                        {article?.isVerified ? (
                            <div className="flex gap-1.5 items-center text-xs font-inter font-semibold">
                                ...
                                <div className="flex-col">
                                    <span className="text-slate-500 flex items-center "> Zweryfikował </span>
                            ...
                            <span className="text-slate-700 text-xs font-inter font-semibold flex items-center gap-1.5 ">
                                <BsFillQuestionCircleFill className="w-5 h-5 text-slate-600" /> Niezweryfikowany
                            </span>
                        )}
                        <button
    ...
    ${
        clipBoardCopyMessage === "Skopiowano!"
            ...
            : "bg-blue-500/90 text-sky-50 hover:bg-blue-600"
                ...
                <Accordion type="multiple" collapsible defaultValue={["false"]} className="rounded-xl   px-8 py-1 ">
