...
adminRoutes.put("/users/:id/change-role", adminController.changeUserRole);
adminRoutes.put("/users/:id/update", adminController.updateUser);
adminRoutes.get("/products", adminController.findProducts);
adminRoutes.post("/roles/create", adminController.createRole);
