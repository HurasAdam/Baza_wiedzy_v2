...
export const UserController = () => ({
    ...
    getUsersHandler: catchErrors(async (req, res) => {
    ...
    getUsersWithReportCountHandler: catchErrors(async (req, res) => {
    ...
    getUserFavouriteArticlesHandler: catchErrors(async (req, res) => {
        const { userId } = req;
    ...
    getUsersWithArticleCountHandler: catchErrors(async (req, res) => {
        const { startDate, endDate } = req.query;
    ...
    getUsersWithChangeCountHandler: catchErrors(async (req, res) => {
        const { startDate, endDate } = req.query;
